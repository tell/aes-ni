...
template <class T, class U> inline void do_aes_ctr(T &out, const U &cipher)
{
    ...
    fmt::print("aes128enc_ctr,{},{:.5e},{:.5e}\n", num_bytes, bytes_per_sec,
               blocks_per_sec);
}

template <class T> inline void do_aes_ctr_iteration(const T &cipher)
{

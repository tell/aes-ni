...
docker exec -ti ${MY_NAME} bash -c "DEBIAN_FRONTEND=noninteractive apt install -q -y build-essential git cmake libgmp-dev"
...
#docker exec -ti ${MY_NAME} bash -c "apt install -q -y libfmt-dev libspdlog-dev"
